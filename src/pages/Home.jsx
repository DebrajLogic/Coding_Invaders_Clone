...
function Home() {
  return (
    <main className="p-6">
      ...
      <div className="flex">
        <Link
          className="px-6 py-4 border-b-4 border-blue-500 hover:text-blue-500"
          to="/"
        >
          Course
        </Link>
        <Link
          className="px-6 py-4 hover:border-b-4 hover:border-blue-500 hover:text-blue-500"
          to="/"
        >
          Progress
        </Link>
      ...
      <div className="border border-gray-300">
        {/* Breadcrumbs */}
        <div className="flex gap-4 p-6 items-center border border-gray-300">
        ...
        <div className="flex border border-gray-300 m-6">
          <button className="border border-gray-300 flex gap-2 items-center px-6 py-4 hover:border-b-4 hover:border-blue-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <button className="border border-gray-100  flex gap-2 items-center px-6 py-4 hover:border-b-4 hover:border-blue-500">
            Next
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
